...
| **25** | **2026-09-02** | **L1** | **缺陷 A-F 修复 (方豆 "继续")** | **修 truth 层发现的 6 个缺陷** | **零回归** | **A expression 字节切片 / B net-decl 位宽 / C LHS concat zip / D ternary 常量值 / E part-select 宽度 None / F generate-if always; +11 truth 断言; golden ×4 重生成** | **✅ 2835 passed + 1 暂缓 (picorv32 ELK)** |
