...
- [x] host 锚点 (CovergroupInfo.host_module) + compiler 注入 (不双编译)
- [x] query/covergroup.py: Q1 采样链 (委托 fanin) / Q2 反向 (module 顶层 +
      class 类型级 + 实例级) / Q3 rand-约束 (委托 ConstraintTracer)
