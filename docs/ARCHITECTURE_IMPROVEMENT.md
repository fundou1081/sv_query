...
|------|------|------|
| v1 | 全部用 Legacy | ✅ 已废弃 |
| v2 | 添加 [FALLBACK] 日志 | ✅ 已废弃 |
| v3 | Visitor 作为 primary，Legacy 作为 fallback | ✅ 已废弃 |
| v4 | 验证 Visitor 完全覆盖，移除 fallback | ✅ 已废弃 |
| v5 | 废弃 Legacy 方法，抛出 NotImplementedError | ✅ 已完成 |
| v6 | 单dispatch架构 | ⏸️ 暂停 |
