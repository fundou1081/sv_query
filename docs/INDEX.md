...
| 全量 (canonical) | **3293 passed / 0 failed** (`sim/tests/`, `-m "not opensource"`; 8 skipped / 164 deselected) | 2026-09-08 实测 (iter_191 gate, 唯一全量口径见 `TESTING.md`) |
...
| 迭代记录 | `docs/task_tree/iterations/` (180 份, 只增不改) | 每次迭代一份 |
