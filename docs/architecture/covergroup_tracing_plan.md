...
> **G1 ✅ (iter_162) / G2 ✅ (iter_163) / G3 ✅ (iter_165) / G4 ✅ (iter_166)** — covergroup 联系闭环。
...
| Accuracy Claim | covergroup **已转正为观察域** (iter_166 G4): 采样结构/绑定/联系查询承诺; bins 命中语义 = 运行时边界 | audit 分层声明 §1-3 |
...
| **G4** ✅ (iter_166) | Accuracy Claim covergroup **转正** (观察域: 采样结构/绑定/联系查询承诺 L1/L2; bins 命中语义 = 运行时边界; 观察边不进主图 — 数据 fanin 零污染) | ✅ audit §1 建模决策表 +3 行 / §2 L1+L2 / §3 范围 + 运行时边界; README/历史注同步 (纯文档) |
