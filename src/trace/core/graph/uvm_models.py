...
class UVMTestbench:
    ...
    def get_component_by_class(self, class_name: str) -> Optional[UVMComponent]:
        """按类名获取组件"""
    ...
    def to_dot(self) -> str:
        ...
        # 组件节点
        colors = {
            'test': 'lightblue', 'env': 'lightcyan',
            'agent': 'lightyellow', 'driver': 'lightpink',
            'monitor': 'lightgreen', 'sequencer': 'lavender',
            'scoreboard': 'lightgoldenrod', 'sequence': 'white',
        }
