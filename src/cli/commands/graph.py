...
def list_nodes(
    file: Path = typer.Option(..., "--file", "-f", help="SystemVerilog source file"),
    kind: Optional[str] = typer.Option(None, "--kind", "-k", help="Filter by node kind (SIGNAL, EXPRESSION, etc)"),
    module: Optional[str] = typer.Option(None, "--module", "-m", help="Filter by module name"),
    json_output: bool = typer.Option(False, "--json", "-j", help="Output JSON format"),
) -> None:
...
def list_edges(
    file: Path = typer.Option(..., "--file", "-f", help="SystemVerilog source file"),
    kind: Optional[str] = typer.Option(None, "--kind", "-k", help="Filter by edge kind (DRIVER, etc)"),
    src: Optional[str] = typer.Option(None, "--src", "-s", help="Filter by source node"),
    dst: Optional[str] = typer.Option(None, "--dst", "-d", help="Filter by destination node"),
    json_output: bool = typer.Option(False, "--json", "-j", help="Output JSON format"),
) -> None:
