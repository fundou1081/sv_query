...
module top (
    ...
    // 简化：双向端口
        ...
        self.assertTrue(any('port_a' in n for n in nodes), f"port_a 应存在")
        self.assertTrue(any('port_b' in n for n in nodes), f"port_b 应存在")
        self.assertTrue(any('port_c' in n for n in nodes), f"port_c 应存在")
