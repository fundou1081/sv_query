...
'''
        ...
        width = adapter.extract_port_width(ports[0])
        self.assertEqual(width[0], 7, "a MSB 应为 7")
        self.assertEqual(width[1], 0, "a LSB 应为 0")

        width = adapter.extract_port_width(ports[1])
        self.assertEqual(width[0], 15, "b MSB 应为 15")
        self.assertEqual(width[1], 0, "b LSB 应为 0")
