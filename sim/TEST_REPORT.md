...
| ✅ | `regression/test_cross_module_tracking.py::TestMultiLevelHierarchy::test_three_level_hierarchy` | 0.015s |
| ✅ | `regression/test_cross_module_tracking.py::TestArrayOfInstances::test_array_instance` | 0.012s |
| ✅ | `regression/test_cross_module_tracking.py::TestPortWidthMapping::test_different_widths` | 0.014s |
| ✅ | `regression/test_cross_module_tracking.py::TestBidirectionalPort::test_inout_port` | 0.008s |
| ✅ | `regression/test_cross_module_tracking.py::TestCrossModuleClockPath::test_clock_propagation` | 0.016s |
