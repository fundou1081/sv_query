...
| ✅ | `integration/test_advanced_grammar.py::TestSequencePropertyExtraction::test_property` | 0.005s |
...
| ✅ | `integration/test_cdc.py::TestCDC::test_no_clock` | 0.006s |
...
| ✅ | `integration/test_clock_reset_timing.py::TestMultiClockDomain::test_dual_clock_independent` | 0.013s |
...
| ✅ | `integration/test_fan_query.py::TestFanQuery::test_fanin_depth_single_step` | 0.005s |
...
| ✅ | `integration/test_fan_query.py::TestFanQuery::test_fanout_depth_single_step` | 0.007s |
...
| ✅ | `integration/test_hierarchy.py::TestHierarchy::test_deep_hierarchy` | 0.030s |
...
| ✅ | `integration/test_hierarchy.py::TestHierarchy::test_parameterized_module` | 0.019s |
...
| ✅ | `integration/test_module_instance.py::TestModuleInstance::test_chained_instances` | 0.017s |
...
| ✅ | `integration/test_port_inout.py::TestPortInout::test_inout_and_other_ports_coexist` | 0.006s |
