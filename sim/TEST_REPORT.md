...
- **跳过**: 0
- **总计**: 23
- **时间**: 2026-05-14 19:18:00

## 测试结果详情

| 状态 | 测试ID | 时长(秒) |
|------|--------|----------|
| ✅ | `integration/test_graph_diff.py::TestGraphDiff::test_added_edges` | 0.027s |
| ✅ | `integration/test_graph_diff.py::TestGraphDiff::test_added_nodes` | 0.015s |
| ✅ | `integration/test_graph_diff.py::TestGraphDiff::test_diff_reachability` | 0.016s |
...
| ✅ | `integration/test_graph_diff_health.py::TestHealthScore::test_health_score_changed` | 0.009s |
