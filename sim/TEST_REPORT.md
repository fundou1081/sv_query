...
| ✅ | `regression/test_complex_inheritance.py::TestComplexInheritance::test_class_hierarchy_extends` | 0.018s |
| ✅ | `regression/test_complex_inheritance.py::TestComplexInheritance::test_composition_edges` | 0.015s |
