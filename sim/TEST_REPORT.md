...
| ✅ | `integration/test_assign_chain.py::TestAssignChain::test_fanout_chain` | 0.008s |
...
| ✅ | `integration/test_case_stmt.py::TestCaseStmt::test_case_simple` | 0.012s |
...
| ✅ | `integration/test_cdc.py::TestCDC::test_dual_clock_domains` | 0.012s |
| ✅ | `integration/test_cdc.py::TestCDC::test_no_clock` | 0.005s |
| ✅ | `integration/test_cdc.py::TestCDC::test_single_clock_domain` | 0.007s |
| ✅ | `integration/test_cdc_multiclock.py::TestCDCMultiClock::test_clock_domain_traces_all_domains` | 0.015s |
...
| ✅ | `integration/test_clock_edge.py::TestClockEdge::test_always_comb_no_clock_edge` | 0.007s |
...
| ✅ | `integration/test_complex_conditions.py::TestComplexPatternExtraction::test_ternary_in_if` | 0.010s |
...
| ✅ | `integration/test_complex_sequential.py::TestComplexSequential::test_ff_with_while` | 0.012s |
| ✅ | `integration/test_concat_and_hierarchy.py::TestConcatExtraction::test_concat_four_signals` | 0.010s |
...
| ✅ | `integration/test_functions.py::TestFunctions::test_task_simple` | 0.012s |
...
| ✅ | `integration/test_hierarchy.py::TestHierarchy::test_generate_instantiation` | 0.018s |
...
| ✅ | `integration/test_instance_connection.py::TestInstanceConnection::test_instance_port_connection` | 0.013s |
| ✅ | `integration/test_instance_connection.py::TestInstanceConnection::test_multiple_instances` | 0.018s |
...
| ✅ | `integration/test_instance_hierarchy.py::TestInstanceHierarchy::test_nested_instance` | 0.019s |
...
| ✅ | `integration/test_interfaces.py::TestInterfaces::test_interface_class` | 0.005s |
| ✅ | `integration/test_interfaces.py::TestInterfaces::test_interface_simple` | 0.006s |
...
| ✅ | `integration/test_negative_cases.py::TestNegativeCases::test_fork_join_not_supported` | 0.006s |
...
| ✅ | `integration/test_port_reg_detection.py::TestPortRegDetection::test_output_reg_is_port_and_reg` | 0.008s |
